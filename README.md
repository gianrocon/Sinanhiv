...
- Botão **Baciloscopia** na ficha Tuberculose: abre o formulário de Baciloscopia já com os dados do paciente preenchidos (nome, nascimento, cartão SUS, mãe, endereço composto, raça/cor)
...
| Seção | Conteúdo |
|---|---|
| **SINAN** | Fichas de notificação (AIDS Adulto, Tuberculose) |
